...
// Vérifier si un nom d'un auteur a été sélectionné dans l'URL
if (isset($_GET['Auteur'])) {
    $nomAuteur = urldecode($_GET['Auteur']);
    // Construire la requête SQL en fonction du livre sélectionné
    $requete = "SELECT * FROM livre WHERE Auteur_Livre ='$nomAuteur'";
    // Exécuter la requête SQL et récupérer les résultats
    $resultats = $db->query($requete)->fetchAll(PDO::FETCH_ASSOC);
}else {
    // Si aucun Auteur n'a été sélectionné, afficher un message d'erreur
    echo "Aucun Auteur sélectionné";
    exit;
}
?>
...
<body>
    ...
    <!--========== Header ==============-->
    <?php 
  $resultats = $db->query("SELECT * FROM auteur WHERE Nom_Auteur = '$nomAuteur'");
  $auteur = $resultats->fetch(PDO::FETCH_ASSOC);
  $nom_image_Auteur = $auteur['Photo_Auteur'];
  $chemin_Auteur = "images/Profil/Auteur/$nom_image_Auteur";
    ?>
        ...
        <div class="col-lg-12">
            ...
            <div class="gen-breadcrumb-title d-flex align-items-center justify-content-center justify-content-md-start">
                ...
                <div class="row">
                    ...
                    <?php echo "<img src='$chemin_Auteur' alt='Photo de profil de l'auteur' style='width: 100%; height: 100%;'>" ?>
                    ...
                    <h2 class="mb-4">
                        <?php echo $auteur['Nom_Auteur']; ?>
                    </h2>
                            <p class="text-muted mb-0">La description de <?php echo $auteur['Nom_Auteur']; ?> n'est pas encore en ligne. Merci de votre patience. </p>
                        </div>
                        </div>
                    </div>
                    </div>
          ...
          <div class="col-lg-12">
            <div class="pm-inner">
                <div class="gen-more-like">
                    <h5 class="gen-more-title">écrit par l'auteur</h5>
                        <div class="row">
                        <?php 
                        $stmt = $db->prepare("SELECT * FROM Livre WHERE Auteur_Livre = '$nomAuteur'");
                                            $stmt->execute();
                                                    ...
                                                    <div class="gen-movie-contain">
                                                        ...
                                                        <div class="gen-info-contain">
                                                            <div class="gen-movie-info">
                                                                <h3><a href="Livre-detaille.php?Livre=<?php echo urlencode($livre['Nom_livre']); ?>"><?php echo $livre['Nom_livre']; ?></a></h3>
                                                            </div>
