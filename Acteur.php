...
if (isset($_GET['Acteur'])) {
    $nomActeur = urldecode($_GET['Acteur']);
    // Construire la requête SQL en fonction du livre sélectionné
    $requete = "SELECT * FROM acteur WHERE Nom_Acteur ='$nomActeur'";
...
<body>
    ...
    <!--========== Header ==============-->
    <?php 
  $resultats = $db->query("SELECT * FROM acteur WHERE Nom_Acteur = '$nomActeur'");
  $auteur = $resultats->fetch(PDO::FETCH_ASSOC);
  $nom_image_Acteur = $auteur['Photo_Acteur'];
  $chemin_Acteur = "images/Profil/Acteur/$nom_image_Acteur";
    ?>
        ...
        <div class="col-lg-12">
            ...
            <div class="gen-breadcrumb-title d-flex align-items-center justify-content-center justify-content-md-start">
                ...
                <div class="row">
                    ...
                    <?php echo "<img src='$chemin_Acteur' alt='Photo de profil de l'auteur' style='width: 100%; height: 100%;'>" ?>
                    ...
                    <h2 class="mb-4">
                        <?php echo $auteur['Nom_Acteur']; ?>
                    </h2>
                            <p class="text-muted mb-0">La description de <?php echo $auteur['Nom_Acteur']; ?> n'est pas encore en ligne. Merci de votre patience. </p>
                        </div>
                        </div>
                    </div>
                    </div>
          ...
          <div class="col-lg-12">
            <div class="pm-inner">
                <div class="gen-more-like">
                    <h5 class="gen-more-title">A joué dans :</h5>
                        <div class="row">
                        <?php 
                       $stmt = $db->prepare("SELECT * FROM film WHERE Acteur1_Film = :nomActeur OR Acteur2_Film = :nomActeur");
