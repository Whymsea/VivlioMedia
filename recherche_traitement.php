...
$sql = "SELECT Id_Livre, Nom_Livre AS nom, 'livre' AS type, CONCAT('Livre-detaille.php?Livre=', Nom_Livre) AS lien FROM livre WHERE Nom_Livre LIKE '%$search%'
        UNION 
        SELECT Id_Film, Nom_Film AS nom, 'film' AS type, CONCAT('Film-detaille.php?film=', Nom_Film) AS lien FROM film WHERE Nom_Film LIKE '%$search%'";
...
while ($ligne = mysqli_fetch_assoc($resultat)) {
    $resultats[] = array('nom' => $ligne['nom'], 'lien' => $ligne['lien']);
}
