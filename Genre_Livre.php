...
if (isset($_GET['Genre_Livre'])) {
  // Récupérer le genre sélectionné dans l'URL
  $genre_livre = $_GET['Genre_Livre'];
                    ...
                    <nav aria-label="breadcrumb">
                        ...
                        <div class="gen-breadcrumb-container">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><?php echo $genre_livre ?></li>
                            </ol>
                        </div>
                    </nav>
                </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="gen-carousel-movies-style-3 movie-grid style-3">
                                <div class="gen-movie-contain">
                                    ...
                                    <?php echo "<img src='$chemin_livre' alt='streamlab-image'>"?>
                                    ...
                                    <div class="gen-info-contain">
                                        <div class="gen-movie-info">
                                            <h3><a href="single-movie.html"><?php echo $livre['Nom_livre']; ?></a></h3>
                                        </div>
